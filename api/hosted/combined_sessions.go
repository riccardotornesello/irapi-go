...
type WeatherSummary struct {
	MaxPrecipRate     *int64            `json:"max_precip_rate,omitempty"`
...
const (
	...
	BRSao    DisplayName = "BR-Sao"
	DEFra    DisplayName = "DE-Fra"
	JPTok    DisplayName = "JP-Tok"
	USEastOH DisplayName = "US-East-OH"
	USWest   DisplayName = "US-West"
)
...
const (
	...
	MemberImagesFlagsBrPNG       ImagePath = "/member_images/flags/br.png"
	MemberImagesFlagsDePNG       ImagePath = "/member_images/flags/de.png"
	MemberImagesFlagsJpPNG       ImagePath = "/member_images/flags/jp.png"
	MemberImagesFlagsUsAmazonPNG ImagePath = "/member_images/flags/us-amazon.png"
	MemberImagesFlagsWAmazonPNG  ImagePath = "/member_images/flags/w-amazon.png"
)
...
const (
	...
	TrackTypeDirtOval TrackTypeEnum = "dirt_oval"
...
func (api *HostedApi) CombinedSessions() (*HostedCombinedSessionsResponse, error) {
	return api.GetJson[HostedCombinedSessionsResponse]("/data/hosted/combined_sessions")
}