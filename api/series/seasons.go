...
type RaceTimeDescriptor struct {
	...
	SessionTimes     []time.Time `json:"session_times,omitempty"`
}
...
func (api *SeriesApi) Seasons() (*SeriesSeasonsResponse, error) {
	return api.GetJson[SeriesSeasonsResponse]("/data/series/seasons")
}