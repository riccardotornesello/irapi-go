...
func (api *MemberApi) Awards(parameters *awards.MemberAwardsParams) (*awards.None, error) {
	return client.GetJson[awards.None](api.Client, "/data/member/awards", parameters)
}

func (api *MemberApi) AwardInstances(parameters *award_instances.MemberAwardInstancesParams) (*award_instances.None, error) {
	return client.GetJson[award_instances.None](api.Client, "/data/member/award_instances", parameters)
}
