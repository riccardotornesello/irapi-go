...
import (
	"github.com/riccardotornesello/irapi-go/pkg/api/member/award_instances"
	"github.com/riccardotornesello/irapi-go/pkg/api/member/awards"
	"github.com/riccardotornesello/irapi-go/pkg/api/member/chart_data"
	"github.com/riccardotornesello/irapi-go/pkg/api/member/get"
	"github.com/riccardotornesello/irapi-go/pkg/api/member/info"
	"github.com/riccardotornesello/irapi-go/pkg/api/member/participation_credits"
	"github.com/riccardotornesello/irapi-go/pkg/api/member/profile"
