...
type SeriesSeasonsParams struct {
	IncludeSeries *bool `json:"include_series,omitempty,comma"`
	SeasonYear    *int  `json:"season_year,omitempty,comma"`
	SeasonQuarter *int  `json:"season_quarter,omitempty,comma"`
}
