...
import (
	"github.com/riccardotornesello/irapi-go/pkg/api/season/race_guide"
	"github.com/riccardotornesello/irapi-go/pkg/api/season/spectator_subsessionids"
	"github.com/riccardotornesello/irapi-go/pkg/api/season/spectator_subsessionids_detail"
